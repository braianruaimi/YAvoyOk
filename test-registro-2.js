...
console.log('\n🚀 REGISTRANDO COMERCIO DE PRUEBA 2\n');
...
console.log('   Nombre: Comercio Test 2');
  ...
  res.on('end', () => {
    ...
    try {
      ...
      if (res.statusCode === 201) {
        ...
        console.log('\n📋 ID COMERCIO:', response.comercio.id);
        ...
        console.log('3. Usa el código en: http://localhost:5502/verificar-email.html');
      }
    } catch (e) {
      console.log(data);
    }
